            ...
            <div class="container-fluid h-100">
                ...
                <div class="row h-100">
                    ...
                    <div class="col-10 pr-4">
                        <div>
                            <h4 class="mt-4 mb-4 font-weight-bold title__admin"">WEB BROADCAST KMTI</h4></div>
                        ...
                        <div class=" card wrapper__card shadow-sm">
                            ...
                            <div style="height: 75vh; overflow-y: auto">
                                ...
                                <a href="{{ route('manage-users.create') }}"><button
                                        class="btn btn-info text-white mb-3">Create user</button></a>
                            ...
                            <div class="card-header">List Users
                                <div class="btn-actions-pane-right">
                                    <div role="group" class="btn-group-sm btn-group">
                                        <button class="btn btn-focus mr-3 btn__create">Create user</button>
                                    </div>
                                </div>
                            </div>
