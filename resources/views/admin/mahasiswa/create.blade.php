...
@section('content')
    <form class="form__create" method="post" action="{{ route('manage-mahasiswa.store') }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input value="{{ old('nim') }}" type="text" class="form-control form-control-sm" id="nim" name="nim"
        ...
        <div class="form-group row">
            <label for="no_wa" class="col-sm-2 col-form-label col-form-label-sm">Nomer whatsapp
                :</label>
            <div class="col-sm-10">
                <input value="{{ old('no_wa') }}" type="text" class="form-control form-control-sm" id="no_wa" name="no_wa"
        ...
        <div class="form-group row">
            <label for="angkatan" class="col-sm-2 col-form-label col-form-label-sm">Angkatan
                :</label>
            <div class="col-sm-10">
                <input value="{{ old('angkatan') }}" type="text" class="form-control form-control-sm" id="angkatan"
        ...
        <div class="form-group row">
            <label for="id_tele" class="col-sm-2 col-form-label col-form-label-sm">Id telegram
                :</label>
            <div class="col-sm-10">
                <input value="{{ old('id_tele') }}" type="text" class="form-control form-control-sm" id="id_tele"
