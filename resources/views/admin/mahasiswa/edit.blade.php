...
@section('content')
    ...
    <form class="form__create" method="post" action="{{ route('manage-mahasiswa.update', $mahasiswa->id) }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input value="{{ $mahasiswa->name }}" type="text" class="form-control form-control-sm" id="name"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input value="{{ $mahasiswa->nim }}" type="text" class="form-control form-control-sm" id="nim" name="nim"
        ...
        <div class="form-group row">
            <label for="no_wa" class="col-sm-2 col-form-label col-form-label-sm">Nomer whatsapp
                :</label>
            <div class="col-sm-10">
                <input value="{{ $mahasiswa->no_wa }}" type="text" class="form-control form-control-sm" id="no_wa"
                    name="no_wa" placeholder="Masukan nomer whatsapp">
        ...
        <div class="form-group row">
            <label for="angkatan" class="col-sm-2 col-form-label col-form-label-sm">Angkatan
                :</label>
            <div class="col-sm-10">
                <input value="{{ $mahasiswa->angkatan }}" type="text" class="form-control form-control-sm" id="angkatan"
                    name="angkatan" placeholder="Masukan angkatan">
        ...
        <div class="form-group row">
            <label for="id_tele" class="col-sm-2 col-form-label col-form-label-sm">Id telegram
                :</label>
            <div class="col-sm-10">
                <input value="{{ $mahasiswa->id_tele }}" type="text" class="form-control form-control-sm" id="id_tele"
                    name="id_tele" placeholder="Masukan id telegram">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        var email = {!! $email !!}
        var option = new Option(email.email, email.id, true, true);
