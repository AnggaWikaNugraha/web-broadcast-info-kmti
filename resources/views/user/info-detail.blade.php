...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <div class="card-header position-relative row form-group"><label for="nama" class="col-sm-2 col-form-label">Subject</label>
                <div class="col-sm-9 offset-1">{{ $info->subject }}</div>
            </div>

            <div class="card-header position-relative row form-group"><label for="nama" class="col-sm-2 col-form-label">Terkirim</label>
